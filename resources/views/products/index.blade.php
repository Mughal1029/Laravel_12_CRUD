                        ...
                        <tbody>
                            ...
                            @foreach($products as $product)
                             <tr>
                                ...
                                <td>
                                    @if($product->image)
                                    <img class="rounded" src="{{ asset('uploads/products/'.$product->image) }}" alt="" width="50">
                                    @else
                                    <img class="rounded" src="https://placehold.co/600x400" alt="" width="50">
                                    @endif
                                </td>
                                <td>{{ $product->name }}</td>
                                <td>{{ $product->sku }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    class="d-inline" onsubmit="return confirm('Are you sure to want to delete this product?')">
                                    @csrf
                                    @method('DELETE')
